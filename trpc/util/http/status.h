...
/// @brief Returns a text of reason phrase for the HTTP status code.
///
/// @param code is the status code of HTTP response.
/// @return Returns a existing reason phrase text associated with the code, emtpy string otherwise.
...
enum ResponseStatus {
  ...
  _Unused306 = 306,          // RFC 7231, 6.4.6 (Unused)
