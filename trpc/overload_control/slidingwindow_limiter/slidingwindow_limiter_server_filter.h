...
/// @brief Server-side flow control filter based on sliding window.
class SlidingWindowServerFilter : public MessageServerFilter {
 public:
  /// @brief Name of filter
  std::string Name() override { return kSlidingWindowLimiterName; }
 ...
 private:
  SlidingWindowControlConf slidingwindow_conf_;
  SlidingWindowOverloadControllerPtr controller_;
};
