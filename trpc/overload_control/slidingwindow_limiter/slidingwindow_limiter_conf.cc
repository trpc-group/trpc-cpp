...
void SlidingWindowControlConf::Display() const {
...
YAML::Node convert<trpc::overload_control::SlidingWindowControlConf>::encode(
    const trpc::overload_control::SlidingWindowControlConf& config) {
  YAML::Node node;
...
bool convert<trpc::overload_control::SlidingWindowControlConf>::decode(
    const YAML::Node& node, trpc::overload_control::SlidingWindowControlConf& config) {
  if (node["limit"]) {
