...
/// @brief Server-side flow control filter based on fixed time window.
class FixedTimeWindowServerFilter : public MessageServerFilter {
 ...
 private:
  FixedTimeWindowControlConf fixedwindow_conf_;
  FixedTimeWindowOverloadControllerPtr controller_;
};
