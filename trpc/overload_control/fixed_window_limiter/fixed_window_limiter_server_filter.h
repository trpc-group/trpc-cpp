...
/// @brief Server-side fixed window limiting class.
/// @note Mainly limit the concurrency of requests by fixed window algorithm.
class FixedWindowLimiterServerFilter : public MessageServerFilter {
 public:
  /// @brief Name of filter
  std::string Name() override { return kFixedWindowLimiterName; }
 ...
 private:
  FixedWindowLimiterControlConf fixed_window_conf_;
  FixedWindowOverloadControllerPtr service_controller_;
};
