...
/// @brief Name of overload protection limiter based on sliding window.
constexpr char kSlidingWindowLimiterName[] = "sliding_window_limiter";

/// @brief Name of monitoring dimensions for request-based concurrent overload protection rate limiter in sliding window
/// algorithm.
