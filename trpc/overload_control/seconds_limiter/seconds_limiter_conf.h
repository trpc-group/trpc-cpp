...
struct SecondsFuncLimiterConfig {
...
struct SecondsLimiterConf {
  ...
  std::vector<SecondsFuncLimiterConfig> func_limiters;
...
template <>
struct convert<trpc::overload_control::SecondsFuncLimiterConfig> {
  static YAML::Node encode(const trpc::overload_control::SecondsFuncLimiterConfig& config);

  static bool decode(const YAML::Node& node, trpc::overload_control::SecondsFuncLimiterConfig& config);
};

template <>
struct convert<trpc::overload_control::SecondsLimiterConf> {
  static YAML::Node encode(const trpc::overload_control::SecondsLimiterConf& config);

  static bool decode(const YAML::Node& node, trpc::overload_control::SecondsLimiterConf& config);
};
