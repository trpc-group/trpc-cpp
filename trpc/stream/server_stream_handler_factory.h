...
/// @brief Stream handler factory on server side.
class ServerStreamHandlerFactory {
 public:
  static ServerStreamHandlerFactory* GetInstance() {
    static ServerStreamHandlerFactory instance;
    return &instance;
  }
 ...
 private:
  ServerStreamHandlerFactory() = default;

  ServerStreamHandlerFactory(const ServerStreamHandlerFactory&) = delete;
  ServerStreamHandlerFactory& operator=(const ServerStreamHandlerFactory&) = delete;
