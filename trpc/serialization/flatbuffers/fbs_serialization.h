...
/// @brief Implementation of serialization and deserialization based on flatbuffers
class FbsSerialization : public Serialization {
 public:
  SerializationType Type() const { return kFlatBuffersType; }
