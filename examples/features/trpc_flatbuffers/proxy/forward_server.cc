...
#include "examples/features/trpc_flatbuffers/proxy/forward_server.h"
...
int ForwardServer::Initialize() {
  ...
  std::string service_name = fmt::format("{}.{}.{}.{}", "trpc", config.app, config.server, "FbForward");
...
int main(int argc, char** argv) {
  examples::flatbuffers::ForwardServer forward_server;
